...
public class DST {
	...
	public static Vector<String> cook(int f1, int f2, int f3, int f4)  throws IOException {
		//导入数据
		BufferedReader f = new BufferedReader(new FileReader("D:\\JAVAecpliseworkspace\\OurCalculator\\src\\DST\\DSTfood.txt"));
		BufferedReader d = new BufferedReader(new FileReader("D:\\JAVAecpliseworkspace\\OurCalculator\\src\\DST\\DSTdishes.txt"));
		...
		System.out.println(dishes_last);
...
public static Vector<Vector<String>> getdata_dishes(BufferedReader d) throws IOException {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println(cook(18,3,9,22));
		//Vector<Integer> ranks = new Vector<Integer>();
		//ranks.add(5);
		//System.out.println(ranks.contains(5));
	}
